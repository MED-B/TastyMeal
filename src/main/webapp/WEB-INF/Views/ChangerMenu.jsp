...
<div id="countC">Nombre de commandes en attente : ${nbeComEnAtt }</div>
	...
	<div class="row">
     <c:forEach items="${menuachanger}" var="menu">
		<div class="col-md-12 order-md-1">

			<form:form class="needs-validation" novalidate="true" method="POST"
				action="/modifierMenu" modelAttribute="menu" name="theform" id="theform">
                <form:hidden path="code_menu" id="code_menu"
					value="${menu.code_menu}" readonly="true" />
				<form:hidden path="id_restaurateur" id="is_restaurateur"
					value="${menu.id_restaurateur}" readonly="true" />
				<div class="mb-3">

					<label for="items">Repas</label>
					<div class="input-group">

						<form:input path="items" id="items" 
							class="form-control" value="${menu.items }"
							 />
				...
				<div class="mb-3">
					...
					<form:input path="prix" type="number" class="form-control"
						id="eprix" value="${menu.prix }" />

				</div>

				<div class="form-group">
					<label for="exampleFormControlSelect1">Categorie</label>
					<form:select path="categorie" id="categorie" class="form-control" value="${menu.categorie }">
						<option>Pizza</option>
