...
if(session.getAttribute("categorie")!=null)
	categorie.equals((String)session.getAttribute("categorie") );
%>
<%
int nbeComEnAtt=0;
int nbeComEnLivr=0;
					...
					<ul class="list-group mb-3">
						<li class="list-group-item d-flex justify-content-between"><a
							...
							<div class="dropdown-menu" aria-labelledby="categories">
								...
								<a class="dropdown-item" href="consulterMenus">tous les menus</a> <a
									class="dropdown-item" href="pizza">Pizza</a> <a
									class="dropdown-item" href="burger">Burgers</a> <a
									class="dropdown-item" href="traditionnel">Traditionnel</a> <a
									class="dropdown-item" href="grillage">Grillages</a>
				...
				<div class="col-md-8 order-md-1">
					...
					<c:forEach items="${list}" var="menu">
						<div class="col-sm-12">
							<div class="card">
								<div class="card-body">
									<form:form method="POST" action="/passerCommande"
										modelAttribute="menu">
										<h5 class="card-title">
										...
										<p>	<form:input path="items" id="items" value="${menu.items }"
												...
												readonly="true" /> <span>Da </span></p><input class="btn btn-primary" type="submit"
												value="Commander"  />
