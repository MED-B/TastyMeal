...
<body>
	...
	<div
		...
		<nav class="my-2 my-md-0 mr-md-3">
			<a class="p-2 text-dark" href="/">Accuile</a>
			<a class="p-2 text-dark" href="consulterCommandeLivr">Ma Livraison</a> <a
	...
	<div class="container">
		<h2>Liste des commande en attente de livraison</h2>
				...
				<div class="card">
					<div class="card-body">
						<ul>
							...
							<form:form method="POST" action="/actualiserCommandeLivr"
