...
<div class="contianer">
	...
	<div
		...
		<nav class="my-2 my-md-0 mr-md-3">
			<a class="p-2 text-dark" href="/">Accuille</a> <a
				class="p-2 text-dark" href="consulterMenus">Menus</a> <a
				class="p-2 text-dark" href="suivreCommande">Ma Commande</a> <a
				class="p-2 text-dark dropdown-toggle" href="#" id="navbarDropdown"
				role="button" data-toggle="dropdown" aria-haspopup="true"
				aria-expanded="false"> Gerer Compte </a>
			<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				...
				<c:choose>
					...
					<c:otherwise>
						<a class="dropdown-item" href="abonner">Abonner</a>
					</c:otherwise>
				</c:choose>
			</div>
		</nav>
	...
	<div class="container">
		<div class="py-5 text-center">
			<img class="d-block mx-auto mb-4" src="pics/Tasty.png" alt=""
				width="72">
			<h2>Abonnement</h2>
			<p class="lead">vous devez remplir tous les champs pour vous
				abonner à l'application.</p>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-12 order-md-1">
				...
				<form:form class="needs-validation" novalidate="true" method="POST"
					action="/addClient" modelAttribute="client" name="theform"
					id="theform">
					...
					<div class="mb-3">
						<label for="tel">Numéro de Téléphone (FORMAT: 01-23-45-67-89)</label>
						<form:input path="tel" type="tel" class="form-control"
							id="tel" placeholder="0#-##-##-##-##" pattern="[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}" required="true" />
						<div class="invalid-feedback">Please enter your shipping
							address.</div>
					</div>
					...
					<div class="mb-3">
						...
						<form:input path="pass" type="password" class="form-control"
							id="pass" required="true" onkeyup="check()" />
						<div class="invalid-feedback">Please enter a passowrd.</div>
					</div>
					<div class="mb-3">
						<label for="address">Confirmer le mot de passe</label> <input
							type="password" class="form-control" id="confipass" required
							onkeyup="check();">
						<div id="message"></div>
						<div class="invalid-feedback">Please confime the password.</div>
					</div>
